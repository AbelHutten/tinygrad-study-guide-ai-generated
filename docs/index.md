...
The exercises are tested conceptually against Ubuntu and an NVIDIA RTX 4090,
but the core path begins with hardware-neutral and CPU/Python backends. Sections
that require NVIDIA hardware are marked and alternatives are provided where
practical.
...
!!! note "An independent guide"

    This site is not official tinygrad documentation. Code links are pinned to
    a recorded source snapshot, while links to policies and project activity
    point to their live upstream locations.
